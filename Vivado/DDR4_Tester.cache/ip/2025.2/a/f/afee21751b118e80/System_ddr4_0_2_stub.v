...
// Date        : Fri Jul 10 10:47:12 2026
// Host        : DESKTOP-E4FV4MP running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ System_ddr4_0_2_stub.v
// Design      : System_ddr4_0_2
...
(* CORE_GENERATION_INFO = "DDR4_SDRAM, DDR4_SDRAM,{x_ipProduct=Vivado 2017.2.0,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=DDR4_SDRAM,x_ipVersion=2.2, Controller_Type = DDR4_SDRAM, Time_Period = 1250, Input_Clock_Period = 3334, Memory_Type = SODIMMs, Memory_Part = MTA4ATF51264HZ-2G6, Ecc = false, Cas_Latency = 12, Cas_Write_Latency = 11, DQ_Width = 64, Chip_Select = true, Data_Mask = DM_NO_DBI, MEM_ADDR_ORDER = ROW_COLUMN_BANK,  Is_AXI_Enabled = true , Slot_cofiguration =  Single , Clamshell_cofiguration =  false ,IS_FASTER_SPEED_RAM = No, Is_custom_part = false, Memory_Voltage = 1.2V, Phy_Only = Complete_Memory_Controller, Debug_Port = Enable, Burst_Length = 8, System_Clock = Differential, AXI_Selection = true, AXI_Data_Width = 512,  AXI_ArbitrationScheme = RD_PRI_REG, AXI_Narrow_Burst = false, Simulation_Mode = BFM, Debug_Mode = Enable, Example_TG = SIMPLE_TG, Self_Refresh = false, Save_Restore = false, Enable_LVAUX = false,MicroBlaze_ECC = false,  Specify_MandD = false, CLKBOUT_MULT = 4, DIVCLK_DIVIDE = 1, CLKOUT0_DIVIDE = 6}" *) (* X_CORE_INFO = "ddr4_v2_2_28,Vivado 2025.2" *) (* dont_touch = "true" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(sys_rst, c0_sys_clk_p, c0_sys_clk_n, 
  ...
  dbg_rd_data_cmp, dbg_expected_data, dbg_cal_seq, dbg_cal_seq_cnt, dbg_cal_seq_rd_cnt, 
  dbg_rd_valid, dbg_cmp_byte, dbg_rd_data, dbg_cplx_config, dbg_cplx_status, dbg_io_address, 
  dbg_pllGate, dbg_phy2clb_fixdly_rdy_low, dbg_phy2clb_fixdly_rdy_upp, 
  dbg_phy2clb_phy_rdy_low, dbg_phy2clb_phy_rdy_upp, cal_r0_status, cal_post_status, 
