...
-- Date        : Mon Jul 13 09:43:51 2026
-- Host        : DESKTOP-E4FV4MP running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ MPSoC_ext_platform_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : MPSoC_ext_platform_clk_wiz_0_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MPSoC_ext_platform_clk_wiz_0_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MPSoC_ext_platform_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MPSoC_ext_platform_clk_wiz_0_0_clk_wiz is
  signal clk_out1_MPSoC_ext_platform_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_MPSoC_ext_platform_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_MPSoC_ext_platform_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_MPSoC_ext_platform_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_MPSoC_ext_platform_clk_wiz_0_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_MPSoC_ext_platform_clk_wiz_0_0,
      O => clk_out3
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => clk_out1_MPSoC_ext_platform_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_MPSoC_ext_platform_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_MPSoC_ext_platform_clk_wiz_0_0,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MPSoC_ext_platform_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
