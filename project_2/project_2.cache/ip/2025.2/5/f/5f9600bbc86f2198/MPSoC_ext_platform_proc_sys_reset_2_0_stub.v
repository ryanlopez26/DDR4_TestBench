...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ MPSoC_ext_platform_proc_sys_reset_2_0_stub.v
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 400000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN MPSoC_ext_platform_clk_wiz_0_0_clk_out1, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
